...
public class FragmentSecond extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvSms = (TextView) view.findViewById(R.id.tvSMSByWord);
        ...
        btnGetSms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String word = etSms.getText().toString().trim();
                String[] wordItems = word.split(" ");
                Random ran = new Random();

                int randomWord = ran.nextInt(wordItems.length);

                String[] filterARGS = {"%" + wordItems[randomWord] + "%"};
